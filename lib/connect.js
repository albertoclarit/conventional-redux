...
function connectInteractors(klass, interactorNames, mapStateToProps, mapDispatchToProps) {
  ...
  var dispatchToPropCreator = function dispatchToPropCreator(dispatch) {

    if (typeof mapDispatchToProps === 'function') {

      return _extends({}, mapDispatchToProps(dispatch), {
        dispatch: dispatch
      });
    } else {
      return {
  ...
  return (0, _reactRedux.connect)(stateToPropCreator, dispatchToPropCreator)(ConnectedComponent);
}
